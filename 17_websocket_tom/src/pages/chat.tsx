...
import { unsetRoom, useRoomsQuery } from "../lib/rooms";
...
function Chat() {
	...
	let hogeName: string = "hoge";
	// const { data: room } = useRoomsQuery(roomName, isConnected);
	const { data: room } = useRoomsQuery(hogeName, isConnected);
